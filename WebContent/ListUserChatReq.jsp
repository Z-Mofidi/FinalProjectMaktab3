...
<body>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<table class="table table-bordered">
					<tr>
						<td><label class="control-label">Online Free Users:</label></td>
						<td><label class="control-label">Chat Rooms You
								Invited In:</label></td>
					</tr>
					<tr>
						<td>
							<%
								...
								ArrayList<String> freeUsers = entityManager.listFreeUsers();
								if (freeUsers.size() == 0) {
							%>
							<p>freeUsers is empty</p> <%
 	} else {
 		boolean checkboxExist = false;
 %>
							...
							<form action="ChatPage.jsp" method="get">
								...
								%>
								<div class="checkbox">
									<label> <input type="checkbox" name="freeUsersCheckbox"
										value="<%=freeUsers.get(index)%>"> <%=freeUsers.get(index)%>
									</label>
								</div>
								<br>
								...
								%>
								<input type="hidden" name="freeUsersCheckbox"
									value="checkboxExitFalse">
								<%
									}
								%>
								<input type='text' name='chatGroupName' class="form-control"
									placeholder="text"> <br> <input type='hidden'
									name='formCheck' value='newChatForm'>
 ...
 %> <br>
						...
						<td>
							...
							%>
							<p>ChatGroup request for you no exist</p> <%
 	} else {
 %>
							...
							<form action="ChatPage.jsp" method="get">
								...
								%>
								<div class="radio">
									<label> <input type="radio" name="chatGroupRequest"
										value="<%=chatGroupArraye.get(index).getName()%>"> <%=chatGroupArraye.get(index).getName()%>
									</label>
								</div>
								<br>
								<%
								...
								%>
								<br> <input type='hidden' name='formCheck'
									value='acceptChatGroupForm'>
